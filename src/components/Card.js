    ...
    return (
        <div className="mx-auto max-w-sm">
            <div className="flex flex-col justify-center max-w-ms mx-auto bg-white shadow-xl rounded-xl p-5 ">
                <div className="">
                    <img src={kenja_time} alt="profile"
                        className="w-32 mx-auto shadow-xl rounded-xl drop-shadow-sm" />
                </div>
                <div className='text-center mt-5'>
                    <p className='text-xl sm:text-2xl text-gray-900 '>
                        Vladislav 'Vlad' Luchnikov
                    </p>
                    ...
                    <div className=' align-center justify-center mt-4'>
                        ...
                        <a className='flex-1 text-xl m-1 p-1 sm:p-2 text-blue-700 hover:bg-gray-800 rounded-full hover:text-white transition-colors duration-300' href='https://www.linkedin.com/in/ujjawalsidhpura/'>
                            <FaLinkedin />
